...
<p align="justify">
    ...
    <img width="400px" src="{{ site.baseurl }}/assets/img/blog/argmax.png"><br />
    One possibility of this candidate set - is to take complete knowledge base, but has speed and precisiion issues. So authors decided to go ahead with generation of this answer candidate set for each question.<br/>

    Authors went ahead with two approaches: C1 -> where they consider only the Freebase triples that have the question entity in them such that all 1-hop answer entities are included in the candidate set.<br/>
